  ...
  <div class="gradient">
    ...
    <div class="container mx-auto mt-10" v-if="singer">
      ...
      <div class="text-gray-50 mt-[12px]">
        <h1 class="text-gray-50 uppercase">albums:</h1>
      ...
      <div class="text-gray-50 mt-[12px]">
        <h1 class="text-gray-50 uppercase">songs:</h1>
    ...
    <noSuchId v-if="singer === null && !loading"> такого исполнителя. </noSuchId>
  </div>
</template>
...
const noSuchId = defineAsyncComponent(() => import('../../components/global/NoSuchId.vue'))
