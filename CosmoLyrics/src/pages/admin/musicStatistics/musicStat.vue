...
const {singer_count, song_count, total_watches, genre_listen_counts, top_song} = storeToRefs(store);
        ...
        <div class="p-4 sm:ml-64 dark:bg-gray-900 min-h-[100vh]">
            <div class="mt-14 p-4">
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex h-45 rounded bg-gray-50 dark:bg-gray-800 relative gradient-music">
                        <div class="py-6 px-6 dark:text-white flex flex-col">
                            <div class="flex items-center">
                                <Icon icon="noto-v1:woman-singer-light-skin-tone" height="1.8rem" width="1.8rem" class="mr-2"></Icon>
                            ...
                            <div class="flex items-center mt-2">
                                <Icon icon="noto-v1:sign-of-the-horns-medium-light-skin-tone" height="1.8rem" width="1.8rem" class="mr-2"></Icon>
                                <p class="font-semibold">
                            ...
                            <div class="flex items-center mt-2">
                                <Icon icon="noto-v1:woman-bowing-light-skin-tone" height="1.8rem" width="1.8rem" class="mr-2"></Icon>
                                <p class="font-semibold">
                            ...
                            <div class="flex items-center mt-[10px]">
                                <Icon icon="streamline:money-graph-arrow-increase-ascend-growth-up-arrow-stats-graph-right-grow" height="1rem" width="1.8rem" class="mr-2"></Icon>
                        ...
                        <div class="absolute right-5 top-[5%]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="130" height="160" viewBox="0 0 65 70" fill="none">
                    ...
                    >
                            ...
                            <div class="mt-2" v-if="top_song">
                                <div class="chart-table">
                                    <a class="flex items-center text-indigo-700">
                                        <div class="flex w-full justify-between dark:bg-indigo-950 items-center rounded-lg shadow-md px-5 py-3 border-b
                        dark:border-indigo-900 dark:hover:bg-indigo-800 transition duration-250 ease-in-out">
                                            ...
                                            <div class="listens flex items-center">
                                                ...
                                                {{
                                                    top_song.watches > 1000 ? Math.round((top_song.watches /
                                                        1000) * 100) / 100 + 'K' : top_song.watches
                                                }}
                                            </div>
                                        </div>
                                    </a>
                    ...
                    >
                        <template v-slot:title>
                            <p class="text-3xl">Самый залайканный<br> комментарий среди треков</p>
                        </template>
                        <template v-slot:subtitle>
                            Soon...
                        </template>
...
.gradient-music {
    ...
    box-shadow: 0 4px 20px 0 rgba(76, 61, 255, 0.50);
}
